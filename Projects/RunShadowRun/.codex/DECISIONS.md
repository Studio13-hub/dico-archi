# DECISIONS — RunShadowRun
Format: YYYY-MM-DD — Décision — Pourquoi — Impact

- 2026-03-03 — Reboot propre du projet via Studio13 structure — Continuité + clarté — Base stable
- 2026-03-03 — Stack V1: Python + Pygame — MVP rapide + apprentissage — V2 en C plus tard
- 2026-03-03 — Persistance best score via `data/save.json` — Garder la progression entre runs — UX plus motivante
